{
  ...
  system.activationScripts.postActivation.text = ''
    ...
    /usr/bin/install -m 0644 ${./vpn-profiles/sp-beheer-gn2-udp.ovpn} "$gn2_profile/config.ovpn"
    /usr/bin/install -m 0644 ${./vpn-profiles/sp-beheer-gn3-tcp.ovpn} "$gn3_profile/config.ovpn"
  '';
}
