...
let
  ...
  riverInitScript = ''
    ...
    # === Ayu Dark Colors ===
    # base00: 0b0e14 (bg)      base08: f07178 (red)
    # base01: 1f2430           base09: ff8f40 (orange)
    # base02: 272d38           base0A: ffb454 (yellow)
    # base03: 3d424d           base0B: aad94c (green)
    # base04: 6c7380           base0C: 95e6cb (cyan)
    # base05: bfbdb6 (fg)      base0D: 59c2ff (blue)
    # base06: e6e1cf           base0E: d2a6ff (magenta)
    # base07: f3f4f5           base0F: e6b673 (brown)
    ...
    riverctl border-color-urgent 0xf07178
    ...
    # Tag 1: nvim terminals and claude (main monitor)
    riverctl rule-add -title 'nvim-paddock' tags 1
    riverctl rule-add -title 'claude-paddock' tags 1

    # Tag 2: zen browser (main instance)
    riverctl rule-add -app-id 'zen' tags 2

    # Tag 3: dev terminals (ui/api)
    riverctl rule-add -title 'term-ui' tags 4
    riverctl rule-add -title 'term-api' tags 4

    # Tag 4: datagrip
    riverctl rule-add -app-id 'jetbrains-datagrip' tags 8

    # Tag 5: claude (laptop only mode)
    riverctl rule-add -title 'claude-main' tags 16

    # Tag 6: claude system (vertical monitor)
    riverctl rule-add -title 'claude-system' tags 32

    # Tag 7: claude paddock vertical
    riverctl rule-add -title 'claude-paddock-v' tags 64

    # Tag 8: zen browser (vertical, separate instance)
    riverctl rule-add -app-id 'zen-vertical' tags 128

    # Tag 9: teams
    riverctl rule-add -app-id 'teams-for-linux' tags 256
    ...
    # Wallpaper - Solid ayu dark background color (#0b0e14)
    riverctl spawn "swaybg -c '#0b0e14'"
